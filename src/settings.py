...
def showhelp():
    ...
    print("                  - « update » changes the value of an existing variable; or replace a list by the specified value. Create the variable if it doesn't exist.")
    ...
    print("")
    print("  -f file    Full path of the configuration file to be edited or read.")
...
def showhelp_dhcp():
    ...
    print("")
    print("  -f filename          Full path of the DHCP configuration file. The default filename '/etc/dhcp/dhcpd.conf' will be used, if the file exists.")
    print("")
